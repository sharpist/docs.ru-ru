...
- [Записи](#record-types)
- [Методы доступа только для инициализации](#init-only-setters)
...
Однако изменение созданного типа после инициализации является ошибкой из-за присвоения свойству только для инициализации значения вне инициализации.
